...
// -------------------------------------------------------------------
// 1️⃣ مسار جلب الشركات (GET) -> الرابط: /api/companies
// -------------------------------------------------------------------
...
// -------------------------------------------------------------------
// 2️⃣ مسار الحفظ والمزامنة الفعلي (POST) -> هذا الذي يستقبل البيانات ويحفظها
// -------------------------------------------------------------------
app.post('/api/sync', async (req, res) => {
  try {
    ...
    // 💾 الجزء المسؤول عن الحفظ الفعلي والتحديث التلقائي (Bulk Upsert) في قاعدة البيانات
...
// -------------------------------------------------------------------
// 3️⃣ مسار اختبار المتصفح (GET) -> الرابط: /api/sync (لمنع شاشة الخطأ البيضاء)
// -------------------------------------------------------------------
app.get('/api/sync', (req, res) => {
  res.status(200).json({
    status: "success",
    message: "هذا المسار يعمل بنجاح ومستعد لاستقبال المزامنة (POST) من برنامج الديسكتوب."
  });
});
